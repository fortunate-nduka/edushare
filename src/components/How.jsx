...
const How = () => {
  return (
    <section className='py-16 md:py-20 grid grid-cols-1 lg:grid-cols-2 items-center justify-center lg:justify-between gap-y-16'>
      ...
      <div className='grid gap-y-10 order-1 lg:order-2 flex-1'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-y-12 gap-x-16 lg:gap-x-7'>
          {howData.map((hd) => (
            <div className='space-y-6'>
              ...
              <h4 className='font-semibold text-xl text-headingText whitespace-nowrap'>
                {hd.heading}
              </h4>
              <p>{hd.text}</p>
            </div>
