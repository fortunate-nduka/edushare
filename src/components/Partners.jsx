...
const Partners = () => {
  return (
    <section className='py-10 md:py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 place-items-center sm:justify-between gap-y-10'>
      <div className='flex flex-col gap-3 w-[60%] sm:w-[90%] lg:w-full text-center lg:text-left'>
        <h3 className='font-bold text-4xl text-headingText'>400+</h3>{' '}
