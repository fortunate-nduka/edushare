...
const Intro = () => {
  return (
    <section className='pt-10 md:pt-16 pb-14 md:pb-16 flex flex-col lg:flex-row lg:items-center gap-y-10 sm:gap-y-16 w-full'>
      <div className='space-y-5 md:space-y-6 sm:text-center lg:text-left lg:w-[40%]'>
        ...
        <p className='leading-relaxed sm:w-[85%] mx-auto lg:w-full'>
          We designed Connections Academy to give students all across the nation
          a tuition-free online public school that lets them learn.
        </p>
        <Button text='Get Started' classes='bg-tomato text-white' />
        <p className=''>
          Not sure when to start? <span className='text-blue'>Learn more</span>
        </p>
      </div>
